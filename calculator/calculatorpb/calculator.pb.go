...
func (x *MaxRequest) GetValue() int64 {
	if x != nil {
		return x.Value
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x22, 0x0a, 0x0a, 0x4d, 0x61, 0x78, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x25, 0x0a, 0x0b,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x9c,
	0x03, 0x0a, 0x10, 0x43, 0x61, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76,
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	6, // 3: calculator.CaculatorService.Max:input_type -> calculator.MaxRequest
	8, // 4: calculator.CaculatorService.SquareRoot:input_type -> calculator.SquareRootRequest
	1, // 5: calculator.CaculatorService.Sum:output_type -> calculator.SumResponse
	3, // 6: calculator.CaculatorService.PrimeNumberDecomposition:output_type -> calculator.PrimeNumberDecompositionResponse
	5, // 7: calculator.CaculatorService.Average:output_type -> calculator.AverageResponse
	7, // 8: calculator.CaculatorService.Max:output_type -> calculator.MaxResponse
	9, // 9: calculator.CaculatorService.SquareRoot:output_type -> calculator.SquareRootResponse
...
type CaculatorServiceClient interface {
	...
	Max(ctx context.Context, opts ...grpc.CallOption) (CaculatorService_MaxClient, error)
	// error handling
...
func (c *caculatorServiceClient) Max(ctx context.Context, opts ...grpc.CallOption) (CaculatorService_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CaculatorService_serviceDesc.Streams[2], "/calculator.CaculatorService/Max", opts...)
	if err != nil {
		return nil, err
	}
	x := &caculatorServiceMaxClient{stream}
	return x, nil
}

type CaculatorService_MaxClient interface {
	Send(*MaxRequest) error
	Recv() (*MaxResponse, error)
	grpc.ClientStream
}

type caculatorServiceMaxClient struct {
	grpc.ClientStream
}

func (x *caculatorServiceMaxClient) Send(m *MaxRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *caculatorServiceMaxClient) Recv() (*MaxResponse, error) {
	m := new(MaxResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *caculatorServiceClient) SquareRoot(ctx context.Context, in *SquareRootRequest, opts ...grpc.CallOption) (*SquareRootResponse, error) {
	out := new(SquareRootResponse)
	err := c.cc.Invoke(ctx, "/calculator.CaculatorService/SquareRoot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CaculatorServiceServer interface {
	...
	// Bi-directional stream
	Max(CaculatorService_MaxServer) error
	// error handling
	// throws INVALID_ARGUMENT error if input is negative
...
func (*UnimplementedCaculatorServiceServer) Max(CaculatorService_MaxServer) error {
	return status.Errorf(codes.Unimplemented, "method Max not implemented")
}
func (*UnimplementedCaculatorServiceServer) SquareRoot(context.Context, *SquareRootRequest) (*SquareRootResponse, error) {
...
func _CaculatorService_Max_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CaculatorServiceServer).Max(&caculatorServiceMaxServer{stream})
}

type CaculatorService_MaxServer interface {
	Send(*MaxResponse) error
	Recv() (*MaxRequest, error)
	grpc.ServerStream
}

type caculatorServiceMaxServer struct {
	grpc.ServerStream
}

func (x *caculatorServiceMaxServer) Send(m *MaxResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *caculatorServiceMaxServer) Recv() (*MaxRequest, error) {
	m := new(MaxRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _CaculatorService_SquareRoot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SquareRootRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CaculatorServiceServer).SquareRoot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CaculatorService/SquareRoot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CaculatorServiceServer).SquareRoot(ctx, req.(*SquareRootRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CaculatorService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CaculatorService_SquareRoot_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "Max",
			Handler:       _CaculatorService_Max_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
